...
tcorr = np.array(range(400*1000))*timestep # in ps
...
fig.savefig('time_converge.pdf',bbox_inches='tight')
...
if args.store:
    with open(args.outfile + '.pkl', 'wb') as file:
        data = [tcorr, j_t200, j_t500, j_t1ns, j_t2ns, j_t4ns, k_t200, k_t500, k_t1ns, k_t2ns, k_t4ns]
        pkl.dump(data, file)
